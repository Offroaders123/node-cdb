...
export class CDBWritable extends EventEmitter {
  ...
  close(cb: (error?: Error) => void): void {
    ...
    function openStreamForHashtable(): void {
      self.hashtableStream = createWriteStream(self.file,{ start: self.filePosition, flags: "r+" });
